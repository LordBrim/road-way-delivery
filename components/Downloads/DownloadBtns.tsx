  ...
  return (
    <div className="flex flex-row gap-6">
      <button
        ...
        className="group flex select-none flex-row items-center justify-center gap-4 rounded-full bg-black py-2 pl-8 pr-2 duration-300 ease-out hover:-translate-y-1 hover:bg-[#1a1a1a] hover:shadow-xl hover:brightness-125"
      >
